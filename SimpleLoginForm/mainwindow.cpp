    ...
    : QMainWindow(parent)
{
    QLabel *l=new QLabel(this);
       ...
       l->move(100,50);
       QPixmap p("C:/Users/Admin/Desktop/SimpleLoginForm/username.png");
       l->setPixmap(p.scaled(20,20));

       QLabel *lb=new QLabel(this);
       lb->move(180,25);
       lb->setAlignment(Qt::AlignHCenter);
       QPixmap pi("C:/Users/Admin/Desktop/SimpleLoginForm/login.png");
       ...
       QPixmap pix("C:/Users/Admin/Desktop/SimpleLoginForm/password.png");
       ...
       connect(btn,&QPushButton::clicked,[=](){
           ...
           QString p=lie->text();
           if(uname=="janani0415"&& p=="janu2001")
           {
